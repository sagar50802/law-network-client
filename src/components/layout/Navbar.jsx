    ...
    <nav className="sticky top-0 z-40 bg-white/80 backdrop-blur border-b">
      <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <div className="hidden md:flex gap-6 items-center">
          ...
          {/* LIVE */}
          <a href="/live" className="text-red-600 font-semibold">LIVE</a>
          ...
          {isAdmin && (
            <>
              ...
              {/* ✅ ONLY ONE QnA Admin Link (Option B FIXED) */}
              ...
              <button className="ml-2 text-xs border px-2 py-1 rounded" onClick={handleLogout}>
                Logout
              </button>
            </>
          )}
      ...
      {open && (
        <div className="md:hidden px-4 pb-3 flex flex-col gap-2">
          ...
          <a href="/#consultancy" onClick={goConsultancy}>Consultancy</a>
          <a href="/prep">Preparation</a>
          <a href="/qna" className="text-purple-600 font-semibold">QnA Practice</a>
          ...
          <a href="/plagiarism">Plagiarism</a>
          <a href="/research-drafting">Research Drafting</a>
          <a href="/classroom" className="text-green-600 font-semibold">Classroom</a>
          <a href="/library">Library</a>
          <a href="/live" className="text-red-600 font-semibold">LIVE</a>
          ...
          {isAdmin && (
            <>
              ...
              <a href="/admin/research-drafting" className="underline">Research Drafting Admin</a>
              ...
              <button className="text-left text-xs border px-2 py-1 rounded w-fit" onClick={handleLogout}>
                Logout
              </button>
            </>
          )}
